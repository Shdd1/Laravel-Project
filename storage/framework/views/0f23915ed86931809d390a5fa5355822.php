...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title>Laravel with shahad <?php echo $__env->yieldContent('title'); ?></title>
    ...
    <body class="antialiased">
        ...
        <!--مكان الكود الغير مكرر نستدعيه هنا فقط -->
        <?php echo $__env->yieldContent(section: 'content'); ?>
                        <?php if(Route::has(name: 'login')): ?>
...
<?php /**PATH C:\xampp\htdocs\sample-laravel-app\projectLaravel\resources\views/layout.blade.php ENDPATH**/ ?>